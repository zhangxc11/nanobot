...
| Phase | 标题 | 日期 |
|-------|------|------|
| 1 | 实时 Session 持久化 (Backlog #7) | 2026-02-25 |
| 2 | 统一 Token 记录 (Backlog #8) | 2026-02-25 |
| 3 | SDK 化改造 (Backlog #6) | 2026-02-26 |
| 4 | 实时 Token 用量记录 | 2026-02-26 |
| Bug Fix | SessionManager 路径双重嵌套 | 2026-02-26 |
| 5 | 工具调用间隙用户消息注入 | 2026-02-26 |
| 6 | LLM 调用详情日志 (web-chat Backlog #15) | 2026-02-27 |
| 7 | 文件访问审计日志 | 2026-02-27 |
| 8 | Session 自修复 — 未完成 tool_call 链 + 错误消息清理 | 2026-02-27 |
| 9 | 多飞书租户支持 | 2026-02-27 |
| 10 | media 参数支持 | 2026-02-27 |
